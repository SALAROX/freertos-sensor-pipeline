...
#define GETU16(a)           (((Word)(a)[0] << 8) | (Word)(a)[1])/*!< Cast two Big Endian 8-bits byte array to 16-bits unsigned */
...
static inline void * ST_MEMCPY(void *s1, const void *s2, LWord n)      { return memcpy(s1,s2,(Word)n); }             /*  PRQA S 0431 # MISRA 1.1 - string.h from Cosmic only provides functions with low qualified parameters */
#define ST_MEMSET(s1,c,n)                                                   memset(s1,(char)(c),n)                          /*!< map memset to string library code  */
static inline int32_t ST_BYTECMP(void *s1, const void *s2, LWord n)    { return (int32_t)memcmp(s1,s2,(Word)n); }    /*  PRQA S 0431 # MISRA 1.1 - string.h from Cosmic only provides functions with low qualified parameters */
