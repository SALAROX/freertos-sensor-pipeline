...
#define    RFAL_GT_NFCA                      rfalConvMsTo1fc(5U)     /*!< GTA  Digital 1.1  6.10.4.1 & A.2                                                                 */
#define    RFAL_GT_NFCB                      rfalConvMsTo1fc(5U)     /*!< GTB  Digital 1.1  7.9.4.1  & A.3                                                                 */
#define    RFAL_GT_NFCF                      rfalConvMsTo1fc(20U)    /*!< GTF  Digital 1.1  8.7.4.1  & A.4                                                                 */
#define    RFAL_GT_NFCV                      rfalConvMsTo1fc(1U)     /*!< GTV  NFC Forum NFCV Change Request 9.7.1.1 & A.2                                                 */
#define    RFAL_GT_NFCV_ADJUSTED             rfalConvMsTo1fc(1U+4U)  /*!< Adjusted GT for greater interoperability (ISO15693 Dynamic Tags)                                 */
...
#define    RFAL_FDT_LISTEN_NFCV_POLLER       4192U    /*!< t1 min  4192/fc (309,2us)     ISO15693 3 Table 8                                                                */
...
#define    RFAL_FDT_POLL_NFCB_POLLER         6780U    /*!< FDTB,POLL,MIN = TR2B,MIN,DEFAULT Digital 1.1 7.9.3 & A.3                                                        */
#define    RFAL_FDT_POLL_NFCF_POLLER         2672U    /*!< FDTF,POLL,MIN   Digital 1.1  8.7.3 & A.4                                                                        */
#define    RFAL_FDT_POLL_NFCV_POLLER         4192U    /*!< FDTV,POLL  NFC Forum NFCV Change Request A.2                                                                    */
...
typedef struct 
{
    ...
    struct{
        ...
        rfalWumAAWeight  aaWeight;   /*!< When AutoAvg is enables, last measure weight              */
