...
#define RFAL_ISODEP_MAX_S_RETRYS                (5U)     /*!< Number of retries for a S-Block  Digital 1.1 A8 - nRETRY DESELECT: [0,5] WTX[2,5]  */
...
typedef struct
{
    uint8_t      ST_PPSS;                              /*!< Start Byte: [ 1101b | CID[4b] ]          */
    uint8_t      ST_PPS0;                              /*!< Parameter 0:[ 000b | PPS1[1n] | 0001b ]  */
    uint8_t      ST_PPS1;                              /*!< Parameter 1:[ 0000b | DSI[2b] | DRI[2b] ]*/    
} rfalIsoDepPpsReq;
