...
#define CPU_DERIVATIVE_MC9S12G48       /* Name of the selected cpu derivative */
#define CPU_PARTNUM_MC9S12G48VLC       /* Part number of the selected cpu */
