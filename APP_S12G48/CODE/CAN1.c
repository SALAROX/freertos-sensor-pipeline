...
void CAN1_Init(void)
{
  ...
  #if NFC_READER_EXTERIOR
  /* CANIDAR0: AC7=0,AC6=0,AC5=0,AC4=0,AC3=0,AC2=0,AC1=0,AC0=1 */
  setReg8(CANIDAR0, 0xEAU);//For Frame ID: 0x750 --MSB
  /* CANIDAR1: AC7=0,AC6=1,AC5=1,AC4=0,AC3=0,AC2=0,AC1=0,AC0=0 */
  setReg8(CANIDAR1, 0x00U);//For Frame ID: 0x750 --LSB
  #elif NFC_READER_INTERIOR
  /* CANIDAR0: AC7=0,AC6=0,AC5=0,AC4=0,AC3=0,AC2=0,AC1=0,AC0=1 */
  setReg8(CANIDAR0, 0xEAU);//For Frame ID: 0x751 --MSB
  /* CANIDAR1: AC7=0,AC6=1,AC5=1,AC4=0,AC3=0,AC2=0,AC1=0,AC0=0 */
  setReg8(CANIDAR1, 0x20U);//For Frame ID: 0x751 --LSB
  #endif
